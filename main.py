...
window.state('zoomed')  # Ouvre la fenêtre en plein écran
...
texte_input = tk.Text(frame_gauche, height=15, width=70, font=large_font)
texte_input.pack()

tk.Label(frame_gauche, text="Clé AES :").pack()
cle_input = tk.Entry(frame_gauche, width=70, font=large_font)
cle_input.pack()

tk.Button(frame_gauche, text="Chiffrer", command=chiffrement_aes, font=large_font).pack(pady=5)

tk.Label(frame_gauche, text="Résultat chiffré (hex) :").pack()
resultat_chiffre = tk.Text(frame_gauche, height=15, width=70, font=large_font)
resultat_chiffre.pack()

# Partie déchiffrement (droite)
tk.Label(frame_droite, text="Texte chiffré (hex) :").pack()
texte_chiffre_input = tk.Text(frame_droite, height=15, width=70, font=large_font)
texte_chiffre_input.pack()

tk.Label(frame_droite, text="Clé AES :").pack()
cle_dechif_input = tk.Entry(frame_droite, width=70, font=large_font)
cle_dechif_input.pack()

tk.Button(frame_droite, text="Déchiffrer", command=dechiffrement_aes, font=large_font).pack(pady=5)

tk.Label(frame_droite, text="Résultat déchiffré :").pack()
resultat_dechiffre = tk.Text(frame_droite, height=15, width=70, font=large_font)
